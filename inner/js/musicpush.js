      ...
      //推荐音乐数据
        $(data.songlist).each(function(index,ele)
        {
          if (index < 20) {
            ...
            var singer = this.data.singer.name;
            var albumname = this.data.albumname;
            var link = '"https://y.qq.com/n/yqq/song/'+songmid+'.html#stat=y_new.index.new_song.songname"';
            var lihtml = '<div class="rankitem"><a href='+link+' class="rankitem-link"><div class="ranklevel"><span>'+songname+'</span></div><div class="rank-songinfo"><span>'+albumname+'</span></div></a></div>';
